...
Material::Material(ShaderProgram *program, std::vector<Texture2D *> textures) : program(program), textures(std::move(textures)) {}
...
PhongMaterial::PhongMaterial(ShaderProgram *program, std::vector<Texture2D *> textures,
                             int texDiffuse, int texSpecular, float shininess) : Material(program, std::move(textures)),
